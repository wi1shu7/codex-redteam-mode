...
PHASE_DEFAULT_CAPABILITY: dict[str, str] = {
    "web": "page_fetch",
    "recon": "page_fetch",
    "general": "page_fetch",
    ...
    "postex": "code_generation",
    "crypto": "code_generation",
}
...
def infer_required_capabilities(objective: str, phase: str) -> tuple[str, ...]:
    ...
    default = PHASE_DEFAULT_CAPABILITY.get(phase, "page_fetch")
    return tuple(dict.fromkeys(capabilities or [default]))
