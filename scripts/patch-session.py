...
Usage:
    python scripts/patch-session.py --latest             # Clean latest session
    python scripts/patch-session.py --all                # Clean all sessions
    python scripts/patch-session.py --dry-run --latest   # Preview without modifying
    python scripts/patch-session.py --list               # List all sessions
"""
...
from codex.session_patcher import (
    RefusalDetector,
    backup_session,
    clean_session,
    list_session_files,
